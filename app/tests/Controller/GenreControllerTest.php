...
class GenreControllerTest extends WebTestCase
{
     ...
     * @const string
     */
    public const TEST_ROUTE = '/ebay/genres';
     ...
     * @const string
     */
    public const TEST_ROUTE_CREATE = '/ebay/genres/create';
    ...
    public function testEditRoute(): void
    {
        ...
        $genreId = $this->createGenre()->getId();

        $this->httpClient->request('GET', '/ebay/genres/'.$genreId.'/edit');
    ...
    public function testDeleteRoute(): void
    {
        ...
        $this->httpClient->request('GET', '/ebay/genres/'.$genreId.'/delete');
