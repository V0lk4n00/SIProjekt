...
class ReservationControllerTest extends WebTestCase
{
     ...
     * @const string
     */
    public const TEST_ROUTE_CREATE = '/ebay/reservations/create';
    ...
    public function testShowRoute(): void
    {
        ...
        $reservation->setEmail('example@example.com');
        $reservation->setNick('Test Nick');
        $reservation->setContent('Test Content');
        $reservation->setRecord($this->createRecordOwnedBy($user));
        $entityManager->persist($reservation);
        $entityManager->flush();

        $this->httpClient->request('GET', '/ebay/reservations/'.$reservation->getId());
    ...
    public function testDeleteRoute(): void
    {
        ...
        $this->httpClient->request('GET', '/ebay/reservations/'.$reservation->getId().'/delete');
