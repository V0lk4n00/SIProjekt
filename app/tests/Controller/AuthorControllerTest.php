...
class AuthorControllerTest extends WebTestCase
{
     ...
     * @const string
     */
    public const TEST_ROUTE_CREATE = '/ebay/authors/create';
    ...
    public function testEditRoute(): void
    {
        ...
        $this->httpClient->request('GET', '/ebay/authors/'.$authorId.'/edit');
    ...
    public function testDeleteRoute(): void
    {
        ...
        $this->httpClient->request('GET', '/ebay/authors/'.$authorId.'/delete');
